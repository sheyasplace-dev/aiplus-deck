...
import * as numbers from './sections/02-numbers.js';
import * as statement from './sections/03-statement.js';
import * as beliefs from './sections/04-beliefs.js';
...
import * as testimonials from './sections/09-testimonials.js';
import * as pricing from './sections/10-pricing.js';
import * as faq from './sections/11-faq.js';
import * as close from './sections/12-close.js';
...
function boot() {
  ...
  const sections = [
    hero, numbers, statement, beliefs, audience, track, proof,
    speakers, testimonials, pricing, faq, close,
  ];
